...
@defstruct[(cookie/same-site cookie)
...
@defstruct[cookie ([name       (and/c string? cookie-name?)]
                  ...
                  #:omit-constructor]{
  Old version of struct type for cookies the server will send.

  @deprecated[#:what "structure type"
              @racket[cookie/same-site]]{
    The library no longer directly creates instances of this struct type. Avoid
    referencing this struct type in @racket[match] patterns and contracts.
  }
}
